...
Java_com_fxk_bsdiff_NativeLib_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_fxk_bsdiff_utils_FxkBsDiffUtil_diff(JNIEnv *env, jobject thiz, jstring new_file_path,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_fxk_bsdiff_utils_FxkBsDiffUtil_patch(JNIEnv *env, jobject thiz, jstring old_file_path,
                                              jstring patch_file_path, jstring combine_file_path) {
    const char *oldFile = env->GetStringUTFChars(old_file_path, nullptr);
    const char *patchFile = env->GetStringUTFChars(patch_file_path, nullptr);
